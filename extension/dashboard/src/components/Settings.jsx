  ...
  return (
    <div className="fixed inset-0 bg-stone-900/20 flex items-start justify-center z-50 p-6" onClick={onClose}>
      ...
      >
        ...
        <label className="block text-xs text-stone-500 mb-1">This week I'm trying to…</label>
        <textarea
          rows={3}
          value={goals}
        ...
        <p className="text-[11px] text-stone-500 mb-4">
          ...
          <a href="https://openrouter.ai/keys" target="_blank" rel="noreferrer" className="text-accent hover:text-amber-700">
            openrouter.ai/keys
          </a>
          .
        </p>

        <p className="text-xs text-stone-500 mb-1">Summary model</p>
        <p className="text-sm text-stone-800 mb-1">{MODEL_LABEL}</p>
        <p className="text-[11px] text-stone-500 mb-4 font-mono">{DEFAULT_MODEL} · ~$0.001 per summary</p>
        ...
        <div className="flex items-center justify-end gap-3">
          ...
          <button onClick={save} className="bg-accent hover:bg-amber-700 text-white text-sm font-semibold rounded-lg px-4 py-2 transition-colors">
            Save
          </button>
        </div>
      </div>
